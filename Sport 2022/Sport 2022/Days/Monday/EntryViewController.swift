...
class EntryViewController: UIViewController,UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        ServiceLabel(text: planDayLocalDB[0].date, x: 170, y: 80) //Дата тренировки
        
        //Тренировка 1
        traningLabel1.frame = CGRect(x: 25, y: 140, width: 200, height: 22)
        traningLabel1.textAlignment = .left
        traningLabel1.text = planDayLocalDB[0].exercise?.name
        ...
        repeatTextField1.text = String(planDayLocalDB[0].replay)
        ...
        wayTextField1.text = String(planDayLocalDB[0].counter)
        ...
        weightTextField1.text = String(planDayLocalDB[0].weight)
        ...
        traningLabel2.text = planDayLocalDB[1].exercise?.name
        ...
        repeatTextField2.text = String(planDayLocalDB[1].replay)
        ...
        wayTextField2.text = String(planDayLocalDB[1].counter)
        ...
        weightTextField2.text = String(planDayLocalDB[1].weight)
        ...
        traningLabel3.text = planDayLocalDB[2].exercise?.name
        ...
        repeatTextField3.text = String(planDayLocalDB[2].replay)
        ...
        wayTextField3.text = String(planDayLocalDB[2].counter)
        ...
        weightTextField3.text = String(planDayLocalDB[2].weight)
        ...
        traningLabel4.text = planDayLocalDB[3].exercise?.name
        ...
        repeatTextField4.text = String(planDayLocalDB[3].replay)
        ...
        wayTextField4.text = String(planDayLocalDB[3].counter)
        ...
        weightTextField4.text = String(planDayLocalDB[3].weight)
        ...
        traningLabel5.text = planDayLocalDB[4].exercise?.name
        ...
        repeatTextField5.text = String(planDayLocalDB[4].replay)
        ...
        wayTextField5.text = String(planDayLocalDB[4].counter)
        ...
        weightTextField5.text = String(planDayLocalDB[4].weight)
        ...
        traningLabel6.text = planDayLocalDB[5].exercise?.name
        ...
        repeatTextField6.text = String(planDayLocalDB[5].replay)
        ...
        wayTextField6.text = String(planDayLocalDB[5].counter)
        ...
        weightTextField6.text = String(planDayLocalDB[5].weight)
